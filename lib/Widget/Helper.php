...
class Helper
{
     ...
     * @return array
     */
    static public function mergeOptions(array $array1, array $array2, $override = false)
    {
        if (is_array($array2)) {
     ...
     * @return array
     */
    static public function arrayMap($func, array $arr)
    {
        foreach ($arr as &$row) {
            if (is_array($row)) {
     ...
     * @return Array
     */
    static public function filterNotEmpty(&$arr)
    {
        $res = array();
